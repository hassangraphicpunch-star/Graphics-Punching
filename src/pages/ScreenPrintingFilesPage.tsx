...
export const ScreenPrintingFilesPage: React.FC<ScreenPrintingFilesPageProps> = ({ onOpenQuoteModal, onNavigate }) => {
  const printProjects = PORTFOLIO_PROJECTS.filter((p) => p.category === 'screen-printing');
  const [selectedProject, setSelectedProject] = useState<PortfolioItem | null>(null);
  const [isLightboxOpen, setIsLightboxOpen] = useState(false);
  const [lightboxIndex, setLightboxIndex] = useState(0);

  const lightboxImages: LightboxImageItem[] = printProjects.map((p) => ({
    src: p.image,
    title: p.title,
    category: p.category,
  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="bg-[#050505] text-white py-14 sm:py-18 border-b border-zinc-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FFC400]/10 border border-[#FFC400]/25 text-[#FFC400] text-xs font-black tracking-widest uppercase mb-3">
            ...
            <span>PORTFOLIO DIRECTORY / SCREEN PRINTING DESIGN FILES</span>
          </div>

          <h1 className="font-display font-black text-3xl sm:text-5xl md:text-6xl uppercase tracking-tight text-white">
            SCREEN PRINTING <span className="text-[#FFC400]">FILES &amp; SEPARATIONS</span>
          </h1>

          <p className="mt-4 text-zinc-300 text-sm sm:text-base max-w-3xl mx-auto leading-relaxed">
            Press-ready screen printing color separations, spot color channels, simulated process separations, dark garment underbases, and high-opacity film output calibration.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs text-zinc-300">
            <div className="flex items-center gap-1.5 bg-zinc-900/80 border border-zinc-800 px-3.5 py-1.5 rounded-full">
              ...
              <span>Pantone Solid Coated Matched</span>
            </div>
            <div className="flex items-center gap-1.5 bg-zinc-900/80 border border-zinc-800 px-3.5 py-1.5 rounded-full">
              <Clock className="w-3.5 h-3.5 text-[#FFC400]" />
              <span>4–12 Hour Color Separation</span>
            </div>
            <div className="flex items-center gap-1.5 bg-zinc-900/80 border border-zinc-800 px-3.5 py-1.5 rounded-full">
              <Layers className="w-3.5 h-3.5 text-[#FFC400]" />
              <span>Registration &amp; Choke/Spread Underbase</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-[#fafafa] text-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-zinc-200">
            <div>
              <h2 className="font-display font-black text-2xl sm:text-3xl uppercase text-zinc-900">
                Screen Printing Projects ({printProjects.length})
              </h2>
            ...
            <button
              onClick={() => onOpenQuoteModal('screen-printing', 'spot-color')}
            ...
            >
              <span>Order Color Separation</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {printProjects.map((project, idx) => (
              <div
                key={project.id}
                id={`screen-print-item-${project.id}`}
      ...
      {/* 3. TECHNICAL SCREEN PRINTING ATTRIBUTES */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-950 p-6 rounded-2xl border border-zinc-800">
              ...
              <h3 className="font-display font-bold text-base uppercase text-white mb-2">
                Color Separation Formats
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Spot color vectors (.AI/.EPS), Photoshop multi-channel spot color separations (.PSD/DCS 2.0), and separated film positive PDFs.
              </p>
            </div>
            ...
            <div className="bg-zinc-950 p-6 rounded-2xl border border-zinc-800">
              ...
              <h3 className="font-display font-bold text-base uppercase text-white mb-2">
                Pantone Matching &amp; Underbase
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Pantone Solid Coated ink formulas, 1-2 pt choke underbase for dark garments, halftone angles (22.5°/52.5°/82.5°), and frequency calibration.
              </p>
            </div>
            ...
            <div className="bg-zinc-950 p-6 rounded-2xl border border-zinc-800">
              ...
              <h3 className="font-display font-bold text-base uppercase text-white mb-2">
                Automatic &amp; Manual Press Ready
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Clean center-point registration marks, print sequence labels, flash cue notes, and press setup guides to reduce machine setup time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-zinc-950 via-black to-zinc-950 py-12 border-t border-zinc-800 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-4">
          <h2 className="font-display font-black text-2xl sm:text-3xl uppercase">
            Need Press-Ready Color Separations or Apparel Artwork?
          </h2>
          <p className="text-xs sm:text-sm text-zinc-400 max-w-xl mx-auto">
            Upload your artwork. Receive film-ready color separations with registration marks and ink sequence sheets.
          </p>
          <div className="pt-2 flex items-center justify-center gap-3">
            ...
            >
              <span>Get Color Separation Quote ($15–$35)</span>
      ...
      <ImageLightboxModal
        ...
        onOpenQuote={(title) => onOpenQuoteModal('screen-printing', '', title)}
      />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="bg-[#0c0c0e] border border-zinc-800 rounded-2xl max-w-2xl w-full p-6 text-white max-h-[90vh] overflow-y-auto space-y-5">
            <div className="flex items-center justify-between pb-3 border-b border-zinc-800">
              <div>
                <span className="text-[10px] font-black uppercase text-[#FFC400]">Screen Printing Specs</span>
            ...
            <div className="space-y-3 text-xs text-zinc-300">
              ...
              <p><strong className="text-white uppercase">Colors:</strong> {selectedProject.colors || selectedProject.tag}</p>
            ...
            <div className="flex justify-end gap-3 pt-3 border-t border-zinc-800">
              ...
              <button
                onClick={() => {
                  ...
                  onOpenQuoteModal('screen-printing', '', selectedProject.title);
                }}
              ...
              >
                <span>Request Color Separation</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
          </div>
